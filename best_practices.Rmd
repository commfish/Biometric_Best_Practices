...
**Dates**  
Believe it or not there is an internation date/time standard (ISO 8601) the format is:  
yyyy-mm-dd  
*Use it!* Dates regularly have confounding errors - clean them at teh beginning of a script and make all formats consistent (bevcasue what people send you will not be).
...
`f.brief.function.description` I tend toward using something like `f.ricker` or `ricker.fun` or `ricker_fun` to name a Ricker spawner-recruit function. a function names *r*, *rick*, or *sr* doesn't tell you what it does - be at least slightly descriptive. 
