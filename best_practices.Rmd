...
*Use it!* Dates regularly have confounding errors - clean them at the beginning of a script and make all formats consistent (becasue what people send you will not be).
...
Something like `f.ricker` or `ricker.fun` or `ricker_fun` to name a Ricker spawner-recruit function. Functions nameed *r*, *rick*, or *sr* doesn't tell you what it does - be at least slightly descriptive. 
...
* fold your code!   
Use `# load ----` or `# data ----` to create breaks and make it easy to navigate within your scripts and make lengthy analyses much easier to follow. Code "chunks" in Rmarkdown can be folded and you can name it ` ```{r data} ` the same is available in Sweave as ` <<data>>= `
